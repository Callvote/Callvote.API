...
namespace Callvote.API.Features.Votes
{
    ...
    public class Vote
    {
        ...
        /// </summary>
        /// <param name="player">The <see cref="UserIdentifier"/> that called the vote.</param>
        ...
        /// <param name="players">The Hashset of <see cref="UserIdentifier"/>s that will be able to see and vote.</param>
        /// <param name="duration">The voting duration.</param>
        public Vote(UserIdentifier player, string question, string voteType, Action<Vote> callback, HashSet<VoteOption> voteOptions, HashSet<UserIdentifier> players, float duration = 30)
        {
            ...
            this.AllowedPlayers = players ?? new HashSet<UserIdentifier>();
        ...
        /// <param name="players">The Hashset of <see cref="UserIdentifier"/>s that will be able to see and vote.</param>
        /// <param name="duration">The voting duration.</param>
        public Vote(UserIdentifier player, string question, string voteType, IPredefinedVote predefinedVote, HashSet<UserIdentifier> players = null, float duration = 30)
        ...
        /// </summary>
        public UserIdentifier CallVotePlayer { get; }
        ...
        /// </summary>
        public HashSet<UserIdentifier> AllowedPlayers { get; }
        ...
        /// </summary>
        /// <param name="user">The <see cref="UserIdentifier"/> who is will be submiting the vote option.</param>
        ...
        /// </remarks>
        public bool SubmitVoteOption(UserIdentifier user, VoteOption voteOption)
        {
        ...
        public bool TryGetVoteOptionFromCommand(string command, out VoteOption vote)
        {
            ...
            return this.IsVoteOptionPresent(vote);
        }
        ...
        public bool IsVoteOptionPresent(VoteOption vote) => vote != null && this.VoteOptions.Contains(vote);
        ...
        public int GetVoteOptionPercentage(VoteOption voteOption)
        {
            ...
            return !this.Counter.TryGetValue(voteOption, out int count) ? 0 : Math.Min((int)(count / (float)this.AllowedPlayers.Count * 100f), 100);
        }

        /// <summary>
        /// Gets the <see cref="VoteOption"/> that has the most amount of votes .
        /// </summary>
        /// <returns>Ai<see cref="VoteOption"/> with the most amount of votes in this <see cref="Vote"/>.</returns>
        ...
        public virtual string GetMessageFromCallVoteStatus(CallVoteStatus status)
        {
            return status switch
            {
                ...
                CallVoteStatus.VoteCanceled => "The vote was canceled.",
        ...
        public virtual string BuildQuestionMessage()
        {
            ...
            foreach (string optionString in this.VoteOptions.Select(voteOption => $".{voteOption.VoteCommand.Command} = {voteOption.Detail}"))
            {
                stringBuilder.Append(counter == 0 ? $"|  {optionString}  |" : $"  {optionString}  |");
                counter++;
            }
